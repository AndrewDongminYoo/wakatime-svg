...
# Geometry matches AndrewDongminYoo/github-stats-transparent so both sets of
# cards line up on the profile README: a 360px image, a 350px card inset by 5px,
# and content starting at (21, 17).
DEFAULT_CHART_WIDTH = 350
DEFAULT_HEADER_HEIGHT = 24
DEFAULT_ROW_HEIGHT = 26
DEFAULT_RECT_RADIUS = 6
DEFAULT_OUTER_PADDING = 5
DEFAULT_PADDING_X = 16
DEFAULT_PADDING_Y = 12
DEFAULT_GAP_AFTER_HEADER = 12
